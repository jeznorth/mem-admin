...
angular.module('documents')
  .directive('documentMgrLink', [ function () {
    return {
      restrict: 'E',
      scope: {
        project: '=',
      ...
      controller: function ($scope, $log, _, moment, Authentication, DocumentMgrService, TreeModel, ProjectModel) {
  ...
  .directive('documentMgrLinkModal',['$rootScope', '$uibModal', '$log', '$timeout', '_', 'moment', 'Authentication', function ($rootScope, $uibModal, $log, $timeout, _, moment, Authentication){
    return {
      restrict: 'A',
      scope: {
        project: '=',
