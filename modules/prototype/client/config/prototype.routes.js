...
angular.module('prototype').config(['$stateProvider', '_', function ($stateProvider, _) {
  ...
  // PROJECT MAIN
    .state('admin.prototype.projectmain', {
      ...
      controller: function ($uibModal, $window, $timeout, $scope, NgTableParams, Application, Authentication, PrototypeModel, agencies, topics, projects, cedetails, authorizations, phases, inspections, actions, conditions, documents, project) {
  ...
  // 	DOCUMENTS
    .state('admin.prototype.documents', {
      url: '/documents',
      resolve: {},
    ...
    .state('admin.prototype.map', {
      ...
      controller: function (uiGmapIsReady, $scope, NgTableParams, Application, Authentication, PrototypeModel, agencies, topics, projects, cedetails, authorizations, phases, inspections, actions, conditions, documents, project) {
        $scope.authentication = Authentication;
        $scope.application = Application;
