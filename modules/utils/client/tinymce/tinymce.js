/**
 * Forked from https://github.com/angular-ui/ui-tinymce v0.0.18
 *
 * Modified to fix bugs in copy/paste. See https://github.com/angular-ui/ui-tinymce/pull/324.
 *
...
angular.module('utils')
  ...
  .directive('uiTinymce', ['$rootScope', '$compile', '$timeout', '$window', '$sce', 'uiTinymceConfig', 'uiTinymceService', function($rootScope, $compile, $timeout, $window, $sce, uiTinymceConfig, uiTinymceService) {
    ...
    if (uiTinymceConfig.baseUrl) {
      $window.tinymce.baseURL = uiTinymceConfig.baseUrl;
    }
    ...
    return {
      ...
      link: function(scope, element, attrs, ctrls) {
        ...
        $timeout(function() {
          if (options.baseURL){
            $window.tinymce.baseURL = options.baseURL;
          }
          var maybeInitPromise = $window.tinymce.init(options);
        ...
        var unbindEventListener = scope.$on('$tinymce:refresh', function(e, id) {
          ...
          if (angular.isUndefined(id) || id === eid) {
            ...
            $window.tinymce.execCommand('mceRemoveEditor', false, eid);
