...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DATABASE_SERVICE_NAME || 'localhost') + '/' + ( process.env.MONGODB_DATABASE || 'mem-dev'),
    acluri: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DATABASE_SERVICE_NAME || 'localhost') + '/mem-acl-dev',
    options: {
      user: '',
      pass: ''
    },
